...
📸 Kullanım Senaryoları
    ...
    Ürün Ekleme: Envanter menüsünden ürün adı, fiyat ve stok bilgisi girilerek kayıt oluşturulur.

    Satış: "Hızlı Satış" ekranında barkod okutulur. Sepet onaylandığında stoktan düşülür ve satış loglarına işlenir.

    Veresiye İşlemi: Sepet onaylanırken "Borç Ekle" seçilirse, ilgili tutar seçilen kişinin bakiyesine yansıtılır ve stok güncellenir.

    Raporlama: Belirli tarih ar
